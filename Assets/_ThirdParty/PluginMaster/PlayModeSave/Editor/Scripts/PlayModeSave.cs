...
namespace PluginMaster
{
    public class PlayModeSave : UnityEditor.EditorWindow
    {
            ...
            ref System.Collections.Generic.Dictionary<string, ComponentSaveDataKey> refDict)
        {
            ...
            int propCount = 0;
            refDict = new System.Collections.Generic.Dictionary<string, ComponentSaveDataKey>();
            while (prop.NextVisible(true))
            {
                if (prop.propertyType == UnityEditor.SerializedPropertyType.ObjectReference && prop.name != "m_Script")
                {
                    if (prop.objectReferenceValue != null)
                    {
                        ...
                        if (component != null)
                        {
                            var compKey = new ComponentSaveDataKey(component);
                            refDict.Add(prop.propertyPath, compKey);
                        }
                    }
                }
            ...
            System.Collections.Generic.Dictionary<string, ComponentSaveDataKey> refDict, string[] propertyPaths = null)
        {
            ...
            while (prop.NextVisible(true))
            {
                ...
                if (compProperty != null)
                {
                    ...
                    {
                        var CompKey = refDict[prop.propertyPath];
